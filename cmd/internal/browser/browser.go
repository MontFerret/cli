...
import (
	...
	clibrowser "github.com/MontFerret/cli/v2/pkg/browser"
...
func New(store *config.Store) *cobra.Command {
	...
	openCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			pid, err := clibrowser.Open(cmd.Context(), store.GetBrowserOptions())
	...
	closeCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return clibrowser.Close(cmd.Context(), store.GetBrowserOptions(), pid)
		},
	}
