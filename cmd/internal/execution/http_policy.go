...
// AddHTTPPolicyFlags registers outbound HTTP policy flags without making their defaults explicit.
...
// HTTPPolicyOptionsFromCommand translates only explicitly set flags into Ferret policy options.
