...
// AddFSPolicyFlags registers builtin-runtime filesystem policy flags.
...
// FSPolicyFromCommand returns nil when neither filesystem policy flag was explicitly set.
