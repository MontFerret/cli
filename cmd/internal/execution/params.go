...
// ParamFlag is shared by every command that accepts runtime parameters.
const ParamFlag = "param"

// ParseParams decodes JSON values when possible and otherwise preserves their raw string form.
