...
func moduleSearchCommand(service moduleService) *cobra.Command {
...
func moduleInfoCommand(service moduleService) *cobra.Command {
	return &cobra.Command{
		Use:   "info <name>",
...
func modulePublishCommand(service moduleService) *cobra.Command {
	command := &cobra.Command{
		Use:   "publish",
